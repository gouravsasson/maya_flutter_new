...
class AuthRemoteDataSourceImpl implements AuthRemoteDataSource {
  ...
  Future<LoginResponseModel> refreshToken(String refreshToken) async {
    try {
      ...
      final mockResponse = {
        ...
        'access_token': _generateMockToken(1), // 1 hour expiry
        'refresh_token': _generateMockToken(24 * 7), // 1 week expiry
      };
  ...
  String _generateMockToken(int hours) {
    final exp =
    ...
    return 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0Ijo${iat},"exp":${exp}}.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c';
  }
}
