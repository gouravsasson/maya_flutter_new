...
import 'package:my_flutter_app/features/widgets/integration.dart';
import 'package:my_flutter_app/features/widgets/integration_card.dart';
import 'package:my_flutter_app/features/widgets/stat_card.dart';
...
class _IntegrationsPageState extends State<IntegrationsPage> {
  ...
  Future<void> _sendTokensToApi(
    ...
    try {
      ...
      print(payload);
      final response = await getIt<ApiClient>().googleAccessTokenMobile(payload);
      print(response);
      ScaffoldMessenger.of(
        context,
